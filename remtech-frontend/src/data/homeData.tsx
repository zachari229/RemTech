...
export const TESTIMONIALS: DemoTestimonial[] = [
  {
    ...
    avatar: 'FD',
    text: "Grâce à RemTech, j'ai décroché mon premier client en moins de 2 mois. La qualité des cours est incomparable.",
    rating: 5,
    course: 'Maîtriser WordPress en 2026',
  },
  {
    id: 2,
    name: 'Kouassi Mensah',
    ...
    avatar: 'KM',
    text: 'Une formation très pratique qui m’a permis de mieux gérer mes réseaux sociaux et de créer du contenu plus engageant.',
    rating: 5,
  ...
  },
  {
    id: 3,
    name: 'Aminata Traoré',
    role: 'Etudiante en Génie Logiciel',
    avatar: 'AT',
    text: "Ce cours m’a permis d’enrichir mes connaissances en culture numérique et surtout de mieux comprendre les métiers du digital. Il m’a aidé à faire un choix plus clair pour mon avenir professionnel.",
    rating: 5,
    course: 'Culture Numérique',
  },
];
